...
class KMeans:
    ...
    def _get_cluster_labels(self, clusters):
        # each sample will get label of the cluster as it was assigned to
    ...
    def _closest_centroid(self, sample, centroids):
        # distance of current sample from each centroid
    ...
    def _is_converged(self, centroids_old, centroids):
        # check distances old and new centroids for all centroids
